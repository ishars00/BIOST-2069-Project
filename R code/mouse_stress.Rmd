...
directory_path <- here("GSE167536", "GSE167536_RAW")
...
mouse_col_data<-read_csv(here("GSE167536", "mouse_Coldata.csv"))

mouse_counts<- read_csv(here("GSE167536", "mouse_counts.csv"))
